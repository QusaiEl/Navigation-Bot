...
uint8_t button_getButton() {
    ...
    if((GPIO_PORTE_DATA_R & 0b00001000) == 0b0){
        return 4;
    }
    else if((GPIO_PORTE_DATA_R & 0b00000100) == 0b0) {
        return 3;
    }
    else if((GPIO_PORTE_DATA_R & 0b00000010) == 0b0) {
        return 2;
    }
    else if((GPIO_PORTE_DATA_R & 0b00000001) == 0b0) {
        return 1;
    } else {
        return 0;
    }
